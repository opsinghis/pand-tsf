...
export function HorizonsSection() {
  return (
    <Section id="horizons" num="20" title="The journey, re-anchored to the 30 October award">
      <p className="sec-sub">
...
export function CautionSection() {
  return (
    <Section id="caution" num="21" title="The cost of caution — shown, not hidden">
...
export function ProofSection() {
  return (
    <Section id="proof" num="22" title="Why this is low-risk">
      <p className="sec-sub">
...
export function PandoraSection() {
  return (
    <Section id="pandora" num="23" title="What we need from Pandora — deliberately lighter">
      <p className="sec-sub">
...
export function StartSection() {
  return (
    <Section id="start" num="24" title="How we start">
      <p className="sec-sub">
