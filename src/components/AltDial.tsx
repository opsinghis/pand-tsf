...
export function DialSection() {
  ...
  return (
    <Section id="dial-explorer" num="17" title="The dial: three service levels on every scope item">
      <p className="sec-sub">
...
export function WalkthroughSection() {
  return (
    <Section id="walkthroughs" num="18" title="The dial in action — two concrete walkthroughs">
      <p className="sec-sub">
...
export function GoalsSection() {
  return (
    <Section id="goals" num="19" title="Everything you asked for, on the gentler path — every stated goal traced">
